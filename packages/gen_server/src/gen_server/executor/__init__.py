    ...
    try:
        ...
        for checkpoint_id, num_images in models.items():
            ...
            components = load_checkpoint(
                file_path, output_keys=output_keys, device="cuda"
            )
            ...
            match checkpoint_metadata.category:
                case "SD1":
                    ...
                    text_encoder_1 = components[
                        "core_extension_1.sd1_text_encoder"
                    ].model
                ...
                case "SD3":
                    ...
                    text_encoder_1 = components[
                        "core_extension_1.sd3_text_encoder_1"
                    ].model
                    text_encoder_2 = components["core_extension_1.text_encoder_2"].model
                    text_encoder_3 = components[
                        "core_extension_1.sd3_text_encoder_3"
                    ].model
            ...
            async for file_metadata in file_handler.upload_png_files(
                pil_images, metadata
            ):
                yield file_metadata
